...
function collectEventDraftData() {
  return {
    ...
    color: getSelectedEventCategory().color
  };
}
...
function applyEventDraftData(draft) {
  ...
  populateEventCategorySelect(draft.category_id || "", draft.color || "");
...
async function saveEvent() {
  ...
  const { category_id, color } = getSelectedEventCategory();
...
function initMobileActionMenu() {
  ...
  const actionTargets = {
    ...
    categories: "categorySettingsBtn",
    ai: "aiScannerTrigger",
    theme: "themeBtn",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  [
    ...
    { id: "dayDetailModal", close: closeDayDetailModal },
    { id: "categorySettingsModal", close: closeCategorySettingsModal },
  ...
  document.getElementById("dayDetailCreateBtn")?.addEventListener("click", () => {
    const dateStr = getDayDetailDate() || formatDate(currentDate);
    closeDayDetailModal();
